...
- **Playground, not production.** This repo is for learning and experiments. Prefer
  small, self-contained programs over framework-heavy structure.
- **Windows-first.** Build and run instructions must work on Windows. Document
  alternatives (e.g. MSVC) when they differ from the primary toolchain.
